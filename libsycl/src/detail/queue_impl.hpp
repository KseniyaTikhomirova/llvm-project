...
public:
  ...
  /// Kernel parameters like dependencies and range must be passed in advance by calling setKernelParameters.
  ...
  /// \return an event impl object that corresponds to the last kernel submission in the calling thread.
...
private:
  ...
  struct KernelSubmitInfo {
    ...
    // TODO: consider storing EventImplPtr here, it will work with plain handle only
